...
class Model:
    ...
    def build_model(self):
		...
		#a = tf.reshape(a, [input_dim, TIME_STEPS]) # this line is not useful. It's just to know which dimension is what.
		a = tf.nn.softmax(a)
		#if self.parameter["SINGLE_ATTENTION_VECTOR"]:
		#	a = Lambda(lambda x: K.mean(x, axis=1), name='dim_reduction')(a)
		#	a = RepeatVector(input_dim)(a)
		a_probs = tf.transpose(a, perm=[2, 1])
		output_attention_mul = merge([sentence_output, a_probs], name='attention_mul', mode='mul')
